...
import org.jwat.common.ByteArrayIOStream.InputStreamImpl;
import org.jwat.common.ByteArrayIOStream.OutputStreamImpl;
...
public class TestByteArrayIOStream {
	...
	public void test_bytearrayiostream_default() {
		...
		Assert.assertEquals(baios.bytes, baios.getBytes());
		Assert.assertEquals(baios.bytes.length, baios.getLength());
